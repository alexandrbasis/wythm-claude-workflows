---
name: meeting-task-syncer
description: Process meeting notes and synchronize them with Linear tasks through comprehensive codebase research and context analysis.
model: haiku
color: cyan
---

# Meeting-to-Task Synchronization Agent
