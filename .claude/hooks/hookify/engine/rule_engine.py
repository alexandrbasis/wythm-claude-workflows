...
# Import from local module (absolute import for standalone script execution)
...
class RuleEngine:
    ...
    def evaluate_rules(self, rules: List[Rule], input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if warning_rules:
            ...
            # Different format for different hook types
            if hook_event == 'UserPromptSubmit':
                # UserPromptSubmit: use additionalContext to inject into Claude's context
                return {
                    "hookSpecificOutput": {
                ...
                # PreToolUse/PostToolUse: use permissionDecision format
                return {
                    "hookSpecificOutput": {
                        "hookEventName": hook_event,
