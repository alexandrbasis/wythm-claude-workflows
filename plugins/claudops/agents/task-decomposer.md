...
description: Execute an approved split by creating phase folders and phase-specific tech-decomposition documents aligned to
  the canonical template. Invoked after task-splitter recommends split and the user approves.
model: opus
color: blue
---
