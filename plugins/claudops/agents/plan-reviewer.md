---
name: plan-reviewer
description: Review a technical decomposition for implementation readiness before `/si`. Validate functional depth, step sequencing,
  codebase fit, testing strategy, and risks; write a canonical plan review document.
model: opus
color: yellow
---
