---
name: task-splitter
description: Use this agent when you need to decide whether a technical decomposition should stay as one implementation task
  or be split into functionally coherent, logically sequenced phases.
model: opus
color: yellow
---
