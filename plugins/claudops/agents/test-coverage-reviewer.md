...
description: Dispatched by /sr to verify test coverage for changed files, including running project test suites. Not intended
  for direct invocation — use /sr for code review workflows.
